...
{
    //parameters for zoom-in and zoom-out
    float minFov = 15f;
    float maxFov = 90f;
    float sensitivity = 10f;
    // movement with right click of mouse
    public float lateralSpeed = 0.015f;
    public float LongitudinalSpeed = 0.08f;
    public float verticalSpeed = 0.001f;
    public float mouseMoevementSpeed = 0.2f;
    public float fovChangeSpeed = 0.08f;
    ...
    public float verticalFilter = 0.03f;
    public float lateralFilter = 0.05f;
    public float LongitudinalFilter = 0.05f;
    public float mouseFilter = 0.04f;
    public float fovFilter = 0.001f;
